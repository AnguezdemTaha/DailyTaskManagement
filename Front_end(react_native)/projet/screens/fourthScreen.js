...
const fourthScreen=props=>{
    ...
    /></View>
        ...
        <Modal visible={moodalOpen} animationType="slide" transparent={true}>
             <Modal visible={true} animationType='fade' transparent={true} >
             <View style={{flex:1,backgroundColor:'black',opacity:0.65}}>
  ...
  size={30}
/>
                    <View style={{flex:0.08,flexDirection:'row',justifyContent:'center',marginTop:10,marginBottom:5}}><TouchableOpacity onPress={()=>setMoodalOpen(false)} style={{flex:0.15,backgroundColor:'#996633',borderRadius:20,justifyContent:'center',alignItems:'center'}}><Text style={{fontSize:20}}>Done</Text></TouchableOpacity></View>
                 </View>
             </View>
        </Modal>
<ImageBackground source={props.route.params.imagee} style={{height:'100%',width:'100%'}}>
         ...
         <View style={{flex:0.15,justifyContent:'center'}}>
            ...
            <TouchableOpacity style={{backgroundColor:'gray',flex:0.103 ,justifyContent:'center',alignItems:'center',borderRadius:30}} onPress={()=>setModalOpen(true)}>
